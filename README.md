...
SEOTitle: Ruiyoung的博客 | BY Blog		# SEO 标题
...
sidebar-avatar: /img/avatar-by.jpeg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
我的博客标题是 **“BY Blog”** 但是我想要在搜索的时候显示 **“Ruiyoung的博客 | BY Blog”** ，这个就需要 SEO Title 来定义了。
