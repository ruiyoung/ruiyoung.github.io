...
# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[Blog](http://qiubaiying.top)搭建出来了。。。
...
keyword: "Blog, Ruiyoung的博客, Ruiyoung" #关键词
url: "https://ruiyoung.github.io/"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
sidebar-avatar:/img/avatar-by.JPEG      # 你的个人头像 这里你可以改成我在img文件夹中的两张备用照片 img/avatar-m 或 avatar-g
```
#### 社交账号
展示你的其他社交平台
